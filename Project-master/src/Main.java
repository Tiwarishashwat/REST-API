...
public class Bricks {
	public int brht=300;
	public int brwdt=500; 
	public int row=3;
	public int col=7;
	public int bsize;
	public int hsize;
	public int bricks[][]= new int [row][col];
				...
				if(bricks[i][j]>0)
					{
						...
						g.fillRect(j*bsize+95, i*hsize +60 , bsize, hsize);
						g.setColor(Color.black);
						g.drawRect(j*bsize+95, i*hsize +60 , bsize, hsize);
					}
